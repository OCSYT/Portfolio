    ...
    return (
        <div className="w-full h-full">
            ...
            <div className="absolute mr-5 inline-block w-9/12">
                <div style={{ width: "calc(" + Amount / 2 + "% - 2vh)", height: "25px" }} className={"languagebar " + BarColor + " p-[.1vw] truncate fixed right-5 rounded-[2.5rem]"}><p className="relative language-text left-5">{Content}</p></div>
            </div>
            <br /><br />
        </div>
    );
